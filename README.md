...
- [Архитектура](#архитектура)
  ...
  - [C4: Container Diagram](#c4-диаграмма-контейнеров)
  - [C4: Deployment Diagram](#c4-диаграмма-деплоймента)
  - [Data Layer Decomposition Diagram](#диаграмма-декомпозиции-слоя-данных)
...
### C4: Диаграмма Деплоймента

**Диаграмма Деплоймента** показывает информацию о том, из каких элементов инфраструктуры и программных компонентов состоит Автоматизированная Система Тестирования.

![Элементы Автоматизированной Системы Тестирования](diagrams/C4-Deployment-Diagram.png)

### Диаграмма Декомпозиции Слоя Данных

**Диаграмма Декомпозиции Слоя Данных** показывает информацию о том, как именно информация хранится в системе, как она "размазывается" на её элементы.

![Элементы Автоматизированной Системы Тестирования](diagrams/DB-Data-layer.png)
